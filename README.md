...
(If some language didn't support, you can create <a href="https://github.com/milwad-dev/laravel-validate/pulls">PR</a> for new language or write custom for yourself)
